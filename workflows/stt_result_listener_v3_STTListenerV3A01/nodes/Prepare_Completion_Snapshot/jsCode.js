...
const checkpointFields = claim.status === 'completed' && String(claim.dialogue || '').trim()
...
if (checkpointFields.some((field) => typeof expectedCheckpoints[field] !== 'string' || !expectedCheckpoints[field])) throw new Error('Completion checkpoint is missing');
