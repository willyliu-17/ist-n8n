...
SELECT
  ...
  stream.deviceInfo.deviceModel AS deviceModel,
  stream.deviceInfo.OSVersion AS osVersion,
  stream.deviceInfo.publicIP AS publicIP,
  stream.deviceInfo.ipRegion AS ipRegion,
